...
public class AtpcoFootnoteRecord2GroupByCatNo {
	
	@Field("_id")
    private String catNo;
	
	@Field("record_2")
    private List<AtpcoFootnoteRecord2> records2;
	...
	public List<AtpcoFootnoteRecord2> getRecords2() {
		return records2;
	}

	public void setRecords2(List<AtpcoFootnoteRecord2> records2) {
	...
	public boolean equals(Object obj) {
		...
		AtpcoFootnoteRecord2GroupByCatNo other = (AtpcoFootnoteRecord2GroupByCatNo) obj;
		if (catNo == null) {
			if (other.catNo != null) {
				return false;
			}
