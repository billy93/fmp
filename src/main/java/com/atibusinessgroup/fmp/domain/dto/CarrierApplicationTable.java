...
public class CarrierApplicationTable {
    ...
    @Field("data_segs")
    private List<CarrierApplicationTableDataSegs> data_segs = new ArrayList<>();
	...
	public List<CarrierApplicationTableDataSegs> getData_segs() {
		return data_segs;
	}

	public void setData_segs(List<CarrierApplicationTableDataSegs> data_segs) {
	...
	public boolean equals(Object obj) {
		...
		CarrierApplicationTable other = (CarrierApplicationTable) obj;
		if (_id == null) {
			if (other._id != null) {
				return false;
			}
