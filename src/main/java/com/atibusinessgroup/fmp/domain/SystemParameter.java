...
public class SystemParameter implements Serializable {
    ...
    public static final String MAX_UNUSED_DAYS_TO_SUSPEND = "MAX_UNUSED_DAYS_TO_SUSPEND", 
			...
			EMAIL_SENDER_CREATE_USER = "EMAIL_SENDER_CREATE_USER",
			EMAIL_SENDER_CHANGE_USER = "EMAIL_SENDER_CHANGE_USER",
			EMAIL_SENDER_RESET_PASSWORD="EMAIL_SENDER_RESET_PASSWORD";
