...
public class AtpcoRecord3Cat21AccompanyingPassengers {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AtpcoRecord3Cat21AccompanyingPassengers other = (AtpcoRecord3Cat21AccompanyingPassengers) obj;
		if (age_max == null) {
	...
	public String toString() {
		return "AtpcoRecord3Cat21AccompanyingPassengers [min_no=" + min_no + ", max_no=" + max_no + ", age_min="
