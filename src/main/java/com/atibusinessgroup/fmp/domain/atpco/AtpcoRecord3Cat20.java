...
@Document(collection = "atpco_record_3_cat_020")
public class AtpcoRecord3Cat20 {
    ...
    private List<AtpcoRecord3Cat20AccompanyingPassengers> accompanying_passengers = new ArrayList<>();
	...
	public List<AtpcoRecord3Cat20AccompanyingPassengers> getAccompanying_passengers() {
		return accompanying_passengers;
	}

	public void setAccompanying_passengers(List<AtpcoRecord3Cat20AccompanyingPassengers> accompanying_passengers) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AtpcoRecord3Cat20 other = (AtpcoRecord3Cat20) obj;
	...
	public String toString() {
		return "AtpcoRecord3Cat20 [id=" + id + ", fbr_fare_currency_1=" + fbr_fare_currency_1
