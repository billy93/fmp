...
public class AtpcoRecord3Cat20AccompanyingPassengers {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AtpcoRecord3Cat20AccompanyingPassengers other = (AtpcoRecord3Cat20AccompanyingPassengers) obj;
		if (age_max == null) {
	...
	public String toString() {
		return "AtpcoRecord3Cat20AccompanyingPassengers [min_no=" + min_no + ", max_no=" + max_no + ", age_min="
