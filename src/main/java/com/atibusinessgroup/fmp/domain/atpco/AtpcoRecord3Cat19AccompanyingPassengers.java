...
public class AtpcoRecord3Cat19AccompanyingPassengers {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AtpcoRecord3Cat19AccompanyingPassengers other = (AtpcoRecord3Cat19AccompanyingPassengers) obj;
		if (age_max == null) {
	...
	public String toString() {
		return "AtpcoRecord3Cat19AccompanyingPassengers [min_no=" + min_no + ", max_no=" + max_no + ", age_min="
