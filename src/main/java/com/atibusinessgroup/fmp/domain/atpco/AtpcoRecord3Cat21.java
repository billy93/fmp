...
@Document(collection = "atpco_record_3_cat_021")
public class AtpcoRecord3Cat21 {
    ...
    private List<AtpcoRecord3Cat21AccompanyingPassengers> accompanying_passengers = new ArrayList<>();
	...
	public List<AtpcoRecord3Cat21AccompanyingPassengers> getAccompanying_passengers() {
		return accompanying_passengers;
	}

	public void setAccompanying_passengers(List<AtpcoRecord3Cat21AccompanyingPassengers> accompanying_passengers) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AtpcoRecord3Cat21 other = (AtpcoRecord3Cat21) obj;
	...
	public String toString() {
		return "AtpcoRecord3Cat21 [id=" + id + ", fbr_fare_currency_1=" + fbr_fare_currency_1
